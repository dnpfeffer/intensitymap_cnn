...
continue_training_model_loc = 'my_model_full_lum_gpu_4_layer_temp.hdf5'
...
fileName = 'my_model_full_lum_gpu_4_layer'
...
dataset = dataset.map(lambda item: tuple(tf.py_func(lnn.utf8FileToMapAndLum, [item, 'basic', True], [tf.float64, tf.float64])))
