...
fileName = 'log_lum_4_layer_2D_model'
...
if make_model:
    ...
    model2.add(keras.layers.Conv3D(16, kernel_size=(2,2), strides=(2,2), activation='relu'))
    ...
    model2.add(keras.layers.BatchNormalization())
    ### use a convolution instead of a pool that acts like a pool
    model2.add(keras.layers.Conv3D(32, kernel_size=(2,2), strides=(2,2), activation='relu'))
    # model2.add(keras.layers.MaxPooling2D(pool_size=(2,2), strides=(2,2)))
    model2.add(keras.layers.Dropout(droprate))
    ...
    model2.add(keras.layers.BatchNormalization())
    ### use a convolution instead of a pool that acts like a pool
    model2.add(keras.layers.Conv3D(64, kernel_size=(2,2), strides=(2,2), activation='relu'))
    # model2.add(keras.layers.MaxPooling2D(pool_size=(2,2), strides=(2,2)))
    model2.add(keras.layers.Dropout(droprate))
    ...
    model2.add(keras.layers.BatchNormalization())
    ### use a convolution instead of a pool that acts like a pool
    model2.add(keras.layers.Conv3D(128, kernel_size=(2,2), strides=(2,2), activation='relu'))
    # model2.add(keras.layers.MaxPooling2D(pool_size=(2,2), strides=(2,2)))
    model2.add(keras.layers.Dropout(droprate))
